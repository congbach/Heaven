...
//			var collisionCheck:CollisionList;
//			if ( Object1 is FlxSprite && Object2 is FlxSprite )
//				collisionCheck = new CollisionList(
//					new Bitmap( ( Object1 as FlxSprite )._framePixels ),
//					new Bitmap( ( Object2 as FlxSprite )._framePixels ) );
//			else if ( Object1 is FlxSprite && Object2 is FlxTilemap )
//				collisionCheck = new CollisionList(
//					new Bitmap(( Object1 as FlxSprite )._framePixels),
//					new Bitmap( (Object2 as FlxTilemap)._buffer ) );
//			else if ( Object2 is FlxSprite )
//				collisionCheck = new CollisionList(
//					new Bitmap( (Object1 as FlxTilemap)._buffer ),
//					new Bitmap( ( Object2 as FlxSprite )._framePixels ) );
//			
////			if ( collisionCheck != null ) trace( collisionCheck.checkCollisions() );
//			if ( collisionCheck != null && collisionCheck.checkCollisions().length == 0 )
//				return false;
		...
		//=========================================================
//		static public function perfectPixelOverlap(Object1:FlxObject,Object2:FlxObject,Callback:Function=null):Boolean
//		{
//			if( (Object1 == null) || !Object1.exists ||
//				(Object2 == null) || !Object2.exists )
//				return false;
...
//			quadTree.add(Object1,FlxQuadTree.A_LIST);
//			if(Object1 === Object2)
//				return quadTree.perfectPixelOverlap(false,Callback);
//			quadTree.add(Object2,FlxQuadTree.B_LIST);
//			return quadTree.perfectPixelOverlap(true,Callback);
//		}
		
//		static public function perfectPixelCollide( Object1:FlxObject, Object2:FlxObject, CallBack:Function = null):Boolean {
//			if( (Object1 == null) || !Object1.exists ||
//				(Object2 == null) || !Object2.exists )
//				return false;
//			var collide:Boolean = false;
//			
//			if ( Object1 is FlxGroup && Object2 is FlxGroup ) {
//				var mem1s:Array = ( Object1 as FlxGroup ).members;
//				var mem2s:Array = ( Object2 as FlxGroup ).members;
//				for each ( var mem1:FlxObject in mem1s ) {
//					for each ( var mem2:FlxObject in mem2s ) {
//						if ( perfectPixelCollide( mem1, mem2, CallBack ) && ! collide )
//							collide = true;
//					}
//				}
//			} else if ( Object1 is FlxGroup ) {
//				var obj1s:Array = ( Object1 as FlxGroup ).members;
//				for each ( var member1:FlxObject in obj1s ) {
//					if ( perfectPixelCollide( member1, Object2, CallBack ) && ! collide )
//						collide = true;
//				}
//			} else if ( Object2 is FlxGroup ) {
//				var obj2s:Array = ( Object2 as FlxGroup ).members;
//				for each ( var member2:FlxObject in obj2s ) {
//					if ( perfectPixelCollide( Object1, member2, CallBack ) && ! collide )
//						collide = true;
//				}
//			} else {
//				if ( Object1 is FlxSprite && Object2 is FlxSprite ) {
//					if ( FlxHitTest.complexHitTestObject( Object1, Object2, 6 ) ) {
...
//						return false;
//					}
//				} else if ( Object1 is FlxTilemap && Object2 is FlxSprite ) {
//					if ( FlxHitTest.complexHitTestObject( Object1, Object2, 6 ) ) {
//						CallBack( Object1, Object2 );
//						return true;
//					} else {
