	...
	*/
	public class FlxSprite extends FlxObject
	{
		...
		*/
		...
		//=================================
		public function loadBitmapDataGraphic( key:String, bitmapData:BitmapData,Animated:Boolean=false,Reverse:Boolean=false,Width:uint=0,Height:uint=0,Unique:Boolean=false):FlxSprite
		{
			_bakedRotation = 0;
			_pixels = FlxG.addBitmapData(bitmapData,Reverse,Unique,key);
			if(Reverse)
				_flipped = _pixels.width>>1;
			else
				_flipped = 0;
...
//		public function removeAnimation(AnimName:String):void {
//			var index:int = -1;
