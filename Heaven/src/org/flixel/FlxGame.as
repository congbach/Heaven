package org.flixel
{
	...
	public class FlxGame extends Sprite
	{
		 ...
		 */
		public function FlxGame(GameSizeX:uint,GameSizeY:uint,InitialState:Class,Zoom:Number=2)
		{
			flash.ui.Mouse.hide();
...
//			switchState(_iState[GameConstants.SINGLETON_STATIC_GET_INSTANCE_CALL]());
