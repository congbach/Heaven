package org.flixel
{
	...
	public class FlxTilemap extends FlxObject
	{
		...
		//===============================================================
		public function loadMapBitmapData(MapData:String, tileBitmapData:BitmapData, TileWidth:uint=0, TileHeight:uint=0):FlxTilemap
		{
			refresh = true;
			...
			//Figure out the size of the tiles
			_pixels = FlxG.addBitmapData(tileBitmapData,false,false,"tilesImages");
			_tileWidth = TileWidth;
			if(_tileWidth == 0)
				_tileWidth = _pixels.height;
			_tileHeight = TileHeight;
