package org.flixel.data
{
	...
	public class FlxInput
	{
		...
		/**
		 * Check to see if any key from the array is pressed.
		 * 
		 * @param	Keys		Array containing some of the key constants listed above (e.g. "LEFT" or "A").
		 * 
		 * @return	Whether any key in the array was just pressed
		 */
		public function pressedAny(Keys:Vector.<String>):Boolean {
		...
		/**
		 * Check to see if any key from the array was just pressed.
		 * 
		 * @param	Keys	Array containing some of the key constants listed above (e.g. "LEFT" or "A").
		 * 
		 * @return	Whether any key in the array was just pressed
		 */
		public function justPressedAny(Keys:Vector.<String>):Boolean {
			for each (var key:String in Keys)
				if (justPressed(key))
					return true;
			return false;
		...
		/**
		 * Check to see if any key from the array was just released.
		 * 
		 * @param	Keys	Array containing some of the key constants listed above (e.g. "LEFT" or "A").
		 * 
		 * @return	Whether any key in the array was just pressed
		 */
		public function justReleasedAny(Keys:Vector.<String>):Boolean {
			for each (var key:String in Keys)
				if (justReleased(key))
					return true;
			return false;
